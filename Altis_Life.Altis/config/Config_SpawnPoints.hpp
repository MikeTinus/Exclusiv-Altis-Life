...
class CfgSpawnPoints {
    ...
    class Kerama {
        class Civilian {
			...
			class RebelN {
				displayName = "Rebellenstützpunkt Flugplatz";
				spawnMarker = "Rebelop";
			...
			class RebelS {
				displayName = "Rebellenstützpunkt Burg";
			...
			class RebelE {
				displayName = "Rebellenstützpunkt Dorf";
		...
		class Cop {
			class Akatoshi {
				displayName = "Polizeipräsidium Akatoshi";
			...
			class Ryoushi {
				displayName = "Polizeidirektion Ryoushi Mura";
			...
			class Airport {
				displayName = "Polizeidirektion Airport";
			...
			class Rand {
				displayName = "Polizeidirektion Akatoshi Ost";
			...
			class BP {
				displayName = "Bundespolizeipräsidium";
		...
		class Medic {
			...
			class Ryoushi {
				displayName = "Ryoushi Mura Regional";
			...
			class Rejidensu {
				displayName = "Rejidensu Konami Hospital";
