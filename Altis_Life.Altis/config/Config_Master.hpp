...
/* System Settings */
    ...
    sendtoJail_locations[] = { "police_hq_1", "police_hq_2", "cop_spawn_1", "cop_spawn_2", "cop_spawn_3", "cop_spawn_4", "cop_spawn_5", "cop_spawn_6", "cop_spawn_7", "Correctional_Facility" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    vehicleShop_rentalOnly[] = { "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F", "B_Heli_Light_01_armed_F", "O_Heli_Attack_02_F", "B_Heli_Attack_01_F", "I_Plane_Fighter_03_AA_F", "O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F", "O_Truck_03_ammo_F", "ACR_Offroad_HMG", "BAF_Offroad_D_HMG", "BAF_Offroad_W_HMG" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
    ...
    vehicle_purchase_multiplier_COP = 1.3; //Cop Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_MEDIC = 1.4; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    /* Vehicle Sell Prices */
    vehicle_sell_multiplier_CIVILIAN = .9; //Civilian Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
    vehicle_sell_multiplier_COP = .9; //Cop Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
    vehicle_sell_multiplier_MEDIC = .9; //Medic Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
    vehicle_sell_multiplier_OPFOR = -1; // -- NOT IN USE -- Simply left in for east support.

    /* "Other" Vehicle Prices */
    vehicle_chopShop_multiplier = .8; //Chop Shop price for vehicles. TO AVOID EXPLOITS NEVER SET HIGHER THAN A PURCHASE/RENTAL multipler!   Payout = Config_vehicle Price * multiplier
    vehicle_storage_fee_multiplier = .2; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
    vehicle_cop_impound_multiplier = .3; //TO AVOID EXPLOITS NEVER SET HIGHER THAN A PURCHASE/RENTAL multipler!   Payout = Config_vehicle Price * multiplier
    ...
    crimes[] = {
		...
		{"STR_Crime_485","1500","485"},
		{"STR_Crime_486","2000","486"},
