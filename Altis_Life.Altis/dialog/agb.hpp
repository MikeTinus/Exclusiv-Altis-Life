class agb
{
    ...
    class controlsBackground
    {
        ...
        class RsclolStatus : Life_RscStructuredText
        {
            ...
            colorBackground[] = {0, 0, 0, 0};
            sizeEx = 0.0001;
            text = "<t size = '0.8'>Unerwünschtes Fehlverhalten führt ggf. zu Bann<br / >§1: Hacking / Cheating / Duping / Belleidigungen<br / >§1.1: Selbstmord / Disconect um sich dem Rollenspiel zu entziehen.<br / >§1.2: Bugs/Exploites ausnutzen - im Zweifel Admin fragen<br / ><br / >§2:RP wird bei uns Groß geschrieben. Hällst du dich nicht an das RP, hast du hier nix verloren!<br / ><br / >§3: RDM / VDM wird sofort geahndet und die Täter gebannt.<br / ><br / >Unsere Kontaktdaten: <br / >TS³ ts3.exclusivgaming.de<br / >Homepage exclusivgaming.de<br / >Admins: <br / >Alex Maier, yenobee, Jan/Erik Master, Hannibal Smith<br / ><br / >Hinweis: Unsere Mod findest du auf der Homepage. Sie ist nur ~80MB groß und fügt hier erst die Sounds und Texturen ein. Du kannst zwar so spielen, aber wirklich schön ist das nicht!<br / ></t> <t font ='PuristaBold' size='0.9'>Um auf Harz 4 Life zu spielen, musst du diesen Regeln zustimmen und du verpflichtest dich dazu, diese einzuhalten.</t>";
            x = 0.1125;
            y = 0.16;
            w = 0.775;
            h = 0.66;
